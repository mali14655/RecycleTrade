    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <div className="flex items-center justify-center gap-3 mb-6">
              ...
              <h1 className="text-5xl font-bold">Mobitrade</h1>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-gray-700 leading-relaxed">
                <p>
                  Mobitrade was founded with a simple yet powerful vision: to make quality technology 
                ...
                <p>
                  Today, Mobitrade has become a trusted name in the refurbished electronics market, 
            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              <h3 className="text-2xl font-semibold text-gray-900 mb-6">Why Choose Mobitrade?</h3>
      ...
      <div className="py-16 bg-black text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold mb-4">Join the Mobitrade Community</h2>
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Whether you're looking to buy quality refurbished devices or sell your old electronics, 
