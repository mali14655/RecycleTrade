...
const FAQ = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "All Mobitrade products come with a minimum 12-month warranty. Some products may have extended warranty periods depending on the manufacturer and product type.",
      points: [
